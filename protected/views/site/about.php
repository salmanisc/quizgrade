        ...
        <div class="row">
            ...
            <aside class="span4 ">
                <div class="col-left">
                    ...
                    <a class=" button_red_small" href="about-us.html">Read more</a>
                    <hr>
                    ...
                    <p><a class=" button_medium" href="contact.html">Apply now</a></p>
                </div><!--End col left -->
            ...
            <section class="span8  ">
                <div class="col-right">
                    <div class="main-img">
                        <img alt="" src="images/img/about.jpg">
                    ...
                    <hr>
                    <p class="text-center"><a class="button_large" href="staff.html">Meet the staff </a></p>
